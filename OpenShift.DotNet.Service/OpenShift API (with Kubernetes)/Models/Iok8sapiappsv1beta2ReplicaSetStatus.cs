...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiappsv1beta2ReplicaSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta2ReplicaSetStatus class.
        /// </summary>
        public Iok8sapiappsv1beta2ReplicaSetStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta2ReplicaSetStatus class.
        /// </summary>
        public Iok8sapiappsv1beta2ReplicaSetStatus(int replicas, int? availableReplicas = default(int?), IList<Iok8sapiappsv1beta2ReplicaSetCondition> conditions = default(IList<Iok8sapiappsv1beta2ReplicaSetCondition>), int? fullyLabeledReplicas = default(int?), long? observedGeneration = default(long?), int? readyReplicas = default(int?))
        {
        ...
        public IList<Iok8sapiappsv1beta2ReplicaSetCondition> Conditions { get; set; }
