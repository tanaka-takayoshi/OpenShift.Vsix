...
namespace OpenShift.DotNet.Service.Models
{
    ...
    public partial class Iok8sapiextensionsv1beta1DeploymentCondition
    {
        ...
        /// Iok8sapiextensionsv1beta1DeploymentCondition class.
        /// </summary>
        public Iok8sapiextensionsv1beta1DeploymentCondition(string status, string type, DateTime? lastTransitionTime = default(DateTime?), DateTime? lastUpdateTime = default(DateTime?), string message = default(string), string reason = default(string))
        {
