...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiextensionsv1beta1RollingUpdateDeployment
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiextensionsv1beta1RollingUpdateDeployment class.
        /// </summary>
        public Iok8sapiextensionsv1beta1RollingUpdateDeployment() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiextensionsv1beta1RollingUpdateDeployment class.
        /// </summary>
        public Iok8sapiextensionsv1beta1RollingUpdateDeployment(string maxSurge = default(string), string maxUnavailable = default(string))
        {
            MaxSurge = maxSurge;
        ...
        /// percentage by rounding up. By default, a value of 1 is used.
        /// Example: when this is set to 30%, the new RC can be scaled up
        /// immediately when the rolling update starts, such that the total
        /// number of old and new pods do not exceed 130% of desired pods.
        /// Once old pods have been killed, new RC can be scaled up further,
        ...
        /// By default, a fixed value of 1 is used. Example: when this is set
        /// to 30%, the old RC can be scaled down to 70% of desired pods
        ...
        /// the new RC, ensuring that the total number of pods available at
