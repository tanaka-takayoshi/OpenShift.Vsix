...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapicorev1NodeSystemInfo
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapicorev1NodeSystemInfo
        /// class.
        /// </summary>
        ...
        /// class.
        /// </summary>
        public Iok8sapicorev1NodeSystemInfo(string architecture, string bootID, string containerRuntimeVersion, string kernelVersion, string kubeProxyVersion, string kubeletVersion, string machineID, string operatingSystem, string osImage, string systemUUID)
        {
