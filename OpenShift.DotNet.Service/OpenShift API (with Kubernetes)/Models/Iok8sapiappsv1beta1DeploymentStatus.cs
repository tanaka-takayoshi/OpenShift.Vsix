...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// Deployment.
    /// </summary>
    public partial class Iok8sapiappsv1beta1DeploymentStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta1DeploymentStatus class.
        /// </summary>
        public Iok8sapiappsv1beta1DeploymentStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta1DeploymentStatus class.
        /// </summary>
        public Iok8sapiappsv1beta1DeploymentStatus(int? availableReplicas = default(int?), int? collisionCount = default(int?), IList<Iok8sapiappsv1beta1DeploymentCondition> conditions = default(IList<Iok8sapiappsv1beta1DeploymentCondition>), long? observedGeneration = default(long?), int? readyReplicas = default(int?), int? replicas = default(int?), int? unavailableReplicas = default(int?), int? updatedReplicas = default(int?))
        {
        ...
        public IList<Iok8sapiappsv1beta1DeploymentCondition> Conditions { get; set; }
