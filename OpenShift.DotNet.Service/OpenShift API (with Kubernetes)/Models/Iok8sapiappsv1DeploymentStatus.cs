...
namespace OpenShift.DotNet.Service.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapiappsv1DeploymentStatus
        /// class.
        /// </summary>
        ...
        /// class.
        /// </summary>
        public Iok8sapiappsv1DeploymentStatus(int? availableReplicas = default(int?), int? collisionCount = default(int?), IList<Iok8sapiappsv1DeploymentCondition> conditions = default(IList<Iok8sapiappsv1DeploymentCondition>), long? observedGeneration = default(long?), int? readyReplicas = default(int?), int? replicas = default(int?), int? unavailableReplicas = default(int?), int? updatedReplicas = default(int?))
        {
        ...
        public IList<Iok8sapiappsv1DeploymentCondition> Conditions { get; set; }
