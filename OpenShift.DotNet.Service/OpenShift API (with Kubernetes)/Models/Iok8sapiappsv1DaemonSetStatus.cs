...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiappsv1DaemonSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapiappsv1DaemonSetStatus
        /// class.
        /// </summary>
        public Iok8sapiappsv1DaemonSetStatus() { }

        /// <summary>
        /// Initializes a new instance of the Iok8sapiappsv1DaemonSetStatus
        /// class.
        /// </summary>
        public Iok8sapiappsv1DaemonSetStatus(int currentNumberScheduled, int desiredNumberScheduled, int numberMisscheduled, int numberReady, int? collisionCount = default(int?), IList<Iok8sapiappsv1DaemonSetCondition> conditions = default(IList<Iok8sapiappsv1DaemonSetCondition>), int? numberAvailable = default(int?), int? numberUnavailable = default(int?), long? observedGeneration = default(long?), int? updatedNumberScheduled = default(int?))
        {
        ...
        public IList<Iok8sapiappsv1DaemonSetCondition> Conditions { get; set; }
