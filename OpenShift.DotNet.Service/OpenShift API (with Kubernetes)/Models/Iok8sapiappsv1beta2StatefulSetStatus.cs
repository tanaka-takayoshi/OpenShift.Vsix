...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiappsv1beta2StatefulSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta2StatefulSetStatus class.
        /// </summary>
        public Iok8sapiappsv1beta2StatefulSetStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta2StatefulSetStatus class.
        /// </summary>
        public Iok8sapiappsv1beta2StatefulSetStatus(int replicas, int? collisionCount = default(int?), IList<Iok8sapiappsv1beta2StatefulSetCondition> conditions = default(IList<Iok8sapiappsv1beta2StatefulSetCondition>), int? currentReplicas = default(int?), string currentRevision = default(string), long? observedGeneration = default(long?), int? readyReplicas = default(int?), string updateRevision = default(string), int? updatedReplicas = default(int?))
        {
        ...
        public IList<Iok8sapiappsv1beta2StatefulSetCondition> Conditions { get; set; }
