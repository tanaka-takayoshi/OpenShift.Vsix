...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// Deployment.
    /// </summary>
    public partial class Iok8sapiextensionsv1beta1DeploymentSpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiextensionsv1beta1DeploymentSpec class.
        /// </summary>
        public Iok8sapiextensionsv1beta1DeploymentSpec() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiextensionsv1beta1DeploymentSpec class.
        /// </summary>
        public Iok8sapiextensionsv1beta1DeploymentSpec(Iok8sapicorev1PodTemplateSpec template, int? minReadySeconds = default(int?), bool? paused = default(bool?), int? progressDeadlineSeconds = default(int?), int? replicas = default(int?), int? revisionHistoryLimit = default(int?), Iok8sapiextensionsv1beta1RollbackConfig rollbackTo = default(Iok8sapiextensionsv1beta1RollbackConfig), Iok8sapimachinerypkgapismetav1LabelSelector selector = default(Iok8sapimachinerypkgapismetav1LabelSelector), Iok8sapiextensionsv1beta1DeploymentStrategy strategy = default(Iok8sapiextensionsv1beta1DeploymentStrategy))
        {
        ...
        /// during the time a deployment is paused. This is not set by
        /// default.
        /// </summary>
        ...
        public Iok8sapiextensionsv1beta1DeploymentStrategy Strategy { get; set; }
