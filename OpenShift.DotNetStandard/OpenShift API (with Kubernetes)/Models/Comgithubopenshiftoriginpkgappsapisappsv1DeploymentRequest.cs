...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// deployment.
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgappsapisappsv1DeploymentRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgappsapisappsv1DeploymentRequest class.
        /// </summary>
        public Comgithubopenshiftoriginpkgappsapisappsv1DeploymentRequest() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgappsapisappsv1DeploymentRequest class.
        /// </summary>
        public Comgithubopenshiftoriginpkgappsapisappsv1DeploymentRequest(bool force, bool latest, string name, string apiVersion = default(string), IList<string> excludeTriggers = default(IList<string>), string kind = default(string))
        {
