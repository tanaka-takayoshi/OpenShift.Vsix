...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapiv1ServicePort
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1ServicePort class.
        /// </summary>
        public Iok8skubernetespkgapiv1ServicePort() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1ServicePort class.
        /// </summary>
        public Iok8skubernetespkgapiv1ServicePort(int port, string name = default(string), int? nodePort = default(int?), string protocol = default(string), string targetPort = default(string))
        {
            Name = name;
            NodePort = nodePort;
            Port = port;
