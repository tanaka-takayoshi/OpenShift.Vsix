...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisextensionsv1beta1DaemonSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisextensionsv1beta1DaemonSetStatus class.
        /// </summary>
        public Iok8skubernetespkgapisextensionsv1beta1DaemonSetStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisextensionsv1beta1DaemonSetStatus class.
        /// </summary>
        public Iok8skubernetespkgapisextensionsv1beta1DaemonSetStatus(int currentNumberScheduled, int desiredNumberScheduled, int numberMisscheduled, int numberReady, long? collisionCount = default(long?), int? numberAvailable = default(int?), int? numberUnavailable = default(int?), long? observedGeneration = default(long?), int? updatedNumberScheduled = default(int?))
        {
