...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgrouteapisroutev1TLSConfig
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgrouteapisroutev1TLSConfig class.
        /// </summary>
        public Comgithubopenshiftoriginpkgrouteapisroutev1TLSConfig() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgrouteapisroutev1TLSConfig class.
        /// </summary>
        public Comgithubopenshiftoriginpkgrouteapisroutev1TLSConfig(string termination, string caCertificate = default(string), string certificate = default(string), string destinationCACertificate = default(string), string insecureEdgeTerminationPolicy = default(string), string key = default(string))
        {
