...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// exposed.
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngress
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngress class.
        /// </summary>
        public Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngress() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngress class.
        /// </summary>
        public Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngress(IList<Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngressCondition> conditions = default(IList<Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngressCondition>), string host = default(string), string routerCanonicalHostname = default(string), string routerName = default(string), string wildcardPolicy = default(string))
        {
        ...
        public IList<Comgithubopenshiftoriginpkgrouteapisroutev1RouteIngressCondition> Conditions { get; set; }
