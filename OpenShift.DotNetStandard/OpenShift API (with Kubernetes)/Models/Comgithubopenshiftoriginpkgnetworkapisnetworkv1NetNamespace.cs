...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgnetworkapisnetworkv1NetNamespace
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgnetworkapisnetworkv1NetNamespace class.
        /// </summary>
        public Comgithubopenshiftoriginpkgnetworkapisnetworkv1NetNamespace() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgnetworkapisnetworkv1NetNamespace class.
        /// </summary>
        public Comgithubopenshiftoriginpkgnetworkapisnetworkv1NetNamespace(long netid, string netname, string apiVersion = default(string), IList<string> egressIPs = default(IList<string>), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
