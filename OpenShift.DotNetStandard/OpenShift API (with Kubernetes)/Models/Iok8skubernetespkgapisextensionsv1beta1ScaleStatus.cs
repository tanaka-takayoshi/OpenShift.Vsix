...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisextensionsv1beta1ScaleStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisextensionsv1beta1ScaleStatus class.
        /// </summary>
        public Iok8skubernetespkgapisextensionsv1beta1ScaleStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisextensionsv1beta1ScaleStatus class.
        /// </summary>
        public Iok8skubernetespkgapisextensionsv1beta1ScaleStatus(int replicas, IDictionary<string, string> selector = default(IDictionary<string, string>), string targetSelector = default(string))
        {
            Replicas = replicas;
            Selector = selector;
