...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfig
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfig class.
        /// </summary>
        public Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfig() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfig class.
        /// </summary>
        public Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfig(Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfigSpec spec, Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfigStatus status, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
        ...
        public Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfigSpec Spec { get; set; }

        /// <summary>
        /// status holds any relevant information about a build config
        /// </summary>
        [JsonProperty(PropertyName = "status")]
        public Comgithubopenshiftoriginpkgbuildapisbuildv1BuildConfigStatus Status { get; set; }
