...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapiv1ServiceSpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1ServiceSpec class.
        /// </summary>
        public Iok8skubernetespkgapiv1ServiceSpec() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1ServiceSpec class.
        /// </summary>
        public Iok8skubernetespkgapiv1ServiceSpec(string clusterIP = default(string), IList<string> externalIPs = default(IList<string>), string externalName = default(string), string externalTrafficPolicy = default(string), int? healthCheckNodePort = default(int?), string loadBalancerIP = default(string), IList<string> loadBalancerSourceRanges = default(IList<string>), IList<Iok8skubernetespkgapiv1ServicePort> ports = default(IList<Iok8skubernetespkgapiv1ServicePort>), IDictionary<string, string> selector = default(IDictionary<string, string>), string sessionAffinity = default(string), string type = default(string))
        {
            ClusterIP = clusterIP;
        ...
        /// be involved. Must be a valid DNS name and requires Type to be
        /// ExternalName.
        /// </summary>
        ...
        public IList<Iok8skubernetespkgapiv1ServicePort> Ports { get; set; }
