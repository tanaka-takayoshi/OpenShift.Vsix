...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisauthorizationv1beta1ResourceAttributes
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Iok8skubernetespkgapisauthorizationv1beta1ResourceAttributes() { }
        ...
        /// class.
        /// </summary>
        public Iok8skubernetespkgapisauthorizationv1beta1ResourceAttributes(string group = default(string), string name = default(string), string namespaceProperty = default(string), string resource = default(string), string subresource = default(string), string verb = default(string), string version = default(string))
        {
            Group = group;
            Name = name;
