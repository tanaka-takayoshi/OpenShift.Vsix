...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// Deployment.
    /// </summary>
    public partial class Iok8skubernetespkgapisappsv1beta1DeploymentStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisappsv1beta1DeploymentStatus class.
        /// </summary>
        public Iok8skubernetespkgapisappsv1beta1DeploymentStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisappsv1beta1DeploymentStatus class.
        /// </summary>
        public Iok8skubernetespkgapisappsv1beta1DeploymentStatus(int? availableReplicas = default(int?), long? collisionCount = default(long?), IList<Iok8skubernetespkgapisappsv1beta1DeploymentCondition> conditions = default(IList<Iok8skubernetespkgapisappsv1beta1DeploymentCondition>), long? observedGeneration = default(long?), int? readyReplicas = default(int?), int? replicas = default(int?), int? unavailableReplicas = default(int?), int? updatedReplicas = default(int?))
        {
        ...
        public IList<Iok8skubernetespkgapisappsv1beta1DeploymentCondition> Conditions { get; set; }
