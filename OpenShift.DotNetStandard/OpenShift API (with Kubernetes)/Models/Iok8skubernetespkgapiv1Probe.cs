...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapiv1Probe
    {
        /// <summary>
        /// Initializes a new instance of the Iok8skubernetespkgapiv1Probe
        /// class.
        /// </summary>
        public Iok8skubernetespkgapiv1Probe() { }

        /// <summary>
        /// Initializes a new instance of the Iok8skubernetespkgapiv1Probe
        /// class.
        /// </summary>
        public Iok8skubernetespkgapiv1Probe(Iok8skubernetespkgapiv1ExecAction exec = default(Iok8skubernetespkgapiv1ExecAction), int? failureThreshold = default(int?), Iok8skubernetespkgapiv1HTTPGetAction httpGet = default(Iok8skubernetespkgapiv1HTTPGetAction), int? initialDelaySeconds = default(int?), int? periodSeconds = default(int?), int? successThreshold = default(int?), Iok8skubernetespkgapiv1TCPSocketAction tcpSocket = default(Iok8skubernetespkgapiv1TCPSocketAction), int? timeoutSeconds = default(int?))
        {
            Exec = exec;
