...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgoauthapisoauthv1OAuthClient
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgoauthapisoauthv1OAuthClient class.
        /// </summary>
        public Comgithubopenshiftoriginpkgoauthapisoauthv1OAuthClient() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgoauthapisoauthv1OAuthClient class.
        /// </summary>
        public Comgithubopenshiftoriginpkgoauthapisoauthv1OAuthClient(int? accessTokenMaxAgeSeconds = default(int?), IList<string> additionalSecrets = default(IList<string>), string apiVersion = default(string), string grantMethod = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta), IList<string> redirectURIs = default(IList<string>), bool? respondWithChallenges = default(bool?), IList<Comgithubopenshiftoriginpkgoauthapisoauthv1ScopeRestriction> scopeRestrictions = default(IList<Comgithubopenshiftoriginpkgoauthapisoauthv1ScopeRestriction>), string secret = default(string))
        {
        ...
        public IList<Comgithubopenshiftoriginpkgoauthapisoauthv1ScopeRestriction> ScopeRestrictions { get; set; }
