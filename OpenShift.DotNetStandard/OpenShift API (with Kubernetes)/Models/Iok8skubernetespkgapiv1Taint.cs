...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapiv1Taint
    {
        /// <summary>
        /// Initializes a new instance of the Iok8skubernetespkgapiv1Taint
        /// class.
        /// </summary>
        public Iok8skubernetespkgapiv1Taint() { }

        /// <summary>
        /// Initializes a new instance of the Iok8skubernetespkgapiv1Taint
        /// class.
        /// </summary>
        public Iok8skubernetespkgapiv1Taint(string effect, string key, DateTime? timeAdded = default(DateTime?), string value = default(string))
        {
            Effect = effect;
            Key = key;
            TimeAdded = timeAdded;
