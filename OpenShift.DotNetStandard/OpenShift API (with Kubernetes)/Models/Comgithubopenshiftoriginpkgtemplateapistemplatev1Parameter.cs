...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgtemplateapistemplatev1Parameter
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgtemplateapistemplatev1Parameter class.
        /// </summary>
        public Comgithubopenshiftoriginpkgtemplateapistemplatev1Parameter() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Comgithubopenshiftoriginpkgtemplateapistemplatev1Parameter class.
        /// </summary>
        public Comgithubopenshiftoriginpkgtemplateapistemplatev1Parameter(string name, string description = default(string), string displayName = default(string), string fromProperty = default(string), string generate = default(string), bool? required = default(bool?), string value = default(string))
        {
