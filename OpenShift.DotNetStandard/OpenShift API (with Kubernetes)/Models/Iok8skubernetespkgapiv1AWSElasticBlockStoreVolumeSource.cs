...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapiv1AWSElasticBlockStoreVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1AWSElasticBlockStoreVolumeSource class.
        /// </summary>
        public Iok8skubernetespkgapiv1AWSElasticBlockStoreVolumeSource() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1AWSElasticBlockStoreVolumeSource class.
        /// </summary>
        public Iok8skubernetespkgapiv1AWSElasticBlockStoreVolumeSource(string volumeID, string fsType = default(string), int? partition = default(int?), bool? readOnlyProperty = default(bool?))
        {
            FsType = fsType;
            Partition = partition;
