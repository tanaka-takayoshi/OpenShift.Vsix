...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisauthorizationv1beta1SubjectAccessReviewSpec
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Iok8skubernetespkgapisauthorizationv1beta1SubjectAccessReviewSpec() { }
        ...
        /// class.
        /// </summary>
        public Iok8skubernetespkgapisauthorizationv1beta1SubjectAccessReviewSpec(IDictionary<string, IList<string>> extra = default(IDictionary<string, IList<string>>), IList<string> group = default(IList<string>), Iok8skubernetespkgapisauthorizationv1beta1NonResourceAttributes nonResourceAttributes = default(Iok8skubernetespkgapisauthorizationv1beta1NonResourceAttributes), Iok8skubernetespkgapisauthorizationv1beta1ResourceAttributes resourceAttributes = default(Iok8skubernetespkgapisauthorizationv1beta1ResourceAttributes), string user = default(string))
        {
            Extra = extra;
            Group = group;
