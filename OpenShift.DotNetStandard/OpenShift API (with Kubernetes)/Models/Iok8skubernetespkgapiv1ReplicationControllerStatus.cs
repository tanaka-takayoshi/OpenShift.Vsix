...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapiv1ReplicationControllerStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1ReplicationControllerStatus class.
        /// </summary>
        public Iok8skubernetespkgapiv1ReplicationControllerStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapiv1ReplicationControllerStatus class.
        /// </summary>
        public Iok8skubernetespkgapiv1ReplicationControllerStatus(int replicas, int? availableReplicas = default(int?), IList<Iok8skubernetespkgapiv1ReplicationControllerCondition> conditions = default(IList<Iok8skubernetespkgapiv1ReplicationControllerCondition>), int? fullyLabeledReplicas = default(int?), long? observedGeneration = default(long?), int? readyReplicas = default(int?))
        {
        ...
        public IList<Iok8skubernetespkgapiv1ReplicationControllerCondition> Conditions { get; set; }
