...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Comgithubopenshiftoriginpkgnetworkapisnetworkv1ClusterNetwork
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Comgithubopenshiftoriginpkgnetworkapisnetworkv1ClusterNetwork() { }
        ...
        /// class.
        /// </summary>
        public Comgithubopenshiftoriginpkgnetworkapisnetworkv1ClusterNetwork(IList<Comgithubopenshiftoriginpkgnetworkapisnetworkv1ClusterNetworkEntry> clusterNetworks, string serviceNetwork, string apiVersion = default(string), long? hostsubnetlength = default(long?), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta), string network = default(string), string pluginName = default(string))
        {
        ...
        public IList<Comgithubopenshiftoriginpkgnetworkapisnetworkv1ClusterNetworkEntry> ClusterNetworks { get; set; }
