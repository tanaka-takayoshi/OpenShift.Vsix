...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisappsv1beta1RollingUpdateDeployment
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisappsv1beta1RollingUpdateDeployment class.
        /// </summary>
        public Iok8skubernetespkgapisappsv1beta1RollingUpdateDeployment() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisappsv1beta1RollingUpdateDeployment class.
        /// </summary>
        public Iok8skubernetespkgapisappsv1beta1RollingUpdateDeployment(string maxSurge = default(string), string maxUnavailable = default(string))
        {
            MaxSurge = maxSurge;
        ...
        /// percentage by rounding up. Defaults to 25%. Example: when this is
        /// set to 30%, the new RC can be scaled up immediately when the
        ...
        /// killed, new RC can be scaled up further, ensuring that total
        /// number of pods running at any time during the update is atmost
        /// 130% of desired pods.
        /// </summary>
        ...
        /// percentage by rounding down. This can not be 0 if MaxSurge is 0.
        /// Defaults to 25%. Example: when this is set to 30%, the old RC can
        /// be scaled down to 70% of desired pods immediately when the
