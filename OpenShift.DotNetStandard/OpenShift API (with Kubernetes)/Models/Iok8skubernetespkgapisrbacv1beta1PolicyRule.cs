...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisrbacv1beta1PolicyRule
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1beta1PolicyRule class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1beta1PolicyRule() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1beta1PolicyRule class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1beta1PolicyRule(IList<string> verbs, IList<string> apiGroups = default(IList<string>), IList<string> nonResourceURLs = default(IList<string>), IList<string> resourceNames = default(IList<string>), IList<string> resources = default(IList<string>))
        {
            ApiGroups = apiGroups;
