...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisextensionsv1beta1ReplicaSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisextensionsv1beta1ReplicaSetStatus class.
        /// </summary>
        public Iok8skubernetespkgapisextensionsv1beta1ReplicaSetStatus() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisextensionsv1beta1ReplicaSetStatus class.
        /// </summary>
        public Iok8skubernetespkgapisextensionsv1beta1ReplicaSetStatus(int replicas, int? availableReplicas = default(int?), IList<Iok8skubernetespkgapisextensionsv1beta1ReplicaSetCondition> conditions = default(IList<Iok8skubernetespkgapisextensionsv1beta1ReplicaSetCondition>), int? fullyLabeledReplicas = default(int?), long? observedGeneration = default(long?), int? readyReplicas = default(int?))
        {
        ...
        public IList<Iok8skubernetespkgapisextensionsv1beta1ReplicaSetCondition> Conditions { get; set; }
