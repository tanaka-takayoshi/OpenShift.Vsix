...
namespace OpenShift.DotNet.Service.Models
{
    ...
    public partial class Iok8skubernetespkgapiv1Container
    {
        ...
        public IList<Iok8skubernetespkgapiv1ContainerPort> Ports { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element2 in this.VolumeMounts)
                {
                    if (element2 != null)
                    {
                        element2.Validate();
