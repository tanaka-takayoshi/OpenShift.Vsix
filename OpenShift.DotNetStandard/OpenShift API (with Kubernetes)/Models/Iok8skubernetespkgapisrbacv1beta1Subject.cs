...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisrbacv1beta1Subject
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1beta1Subject class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1beta1Subject() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1beta1Subject class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1beta1Subject(string kind, string name, string apiGroup = default(string), string namespaceProperty = default(string))
        {
            ApiGroup = apiGroup;
            Kind = kind;
            Name = name;
        ...
        /// <summary>
        /// APIGroup holds the API group of the referenced subject. Defaults
        ...
        /// not recognized the kind value, the Authorizer should report an
        /// error.
        /// </summary>
