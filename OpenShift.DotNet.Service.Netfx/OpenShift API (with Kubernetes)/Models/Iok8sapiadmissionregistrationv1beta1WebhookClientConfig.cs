...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// with the webhook
    /// </summary>
    public partial class Iok8sapiadmissionregistrationv1beta1WebhookClientConfig
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiadmissionregistrationv1beta1WebhookClientConfig class.
        /// </summary>
        public Iok8sapiadmissionregistrationv1beta1WebhookClientConfig() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiadmissionregistrationv1beta1WebhookClientConfig class.
        /// </summary>
        public Iok8sapiadmissionregistrationv1beta1WebhookClientConfig(byte[] caBundle, Iok8sapiadmissionregistrationv1beta1ServiceReference service = default(Iok8sapiadmissionregistrationv1beta1ServiceReference), string url = default(string))
        {
            CaBundle = caBundle;
            Service = service;
            Url = url;
        ...
        /// used. If there are multiple ports open, port 443 will be used if
        /// it is open, otherwise it is an error.
        /// </summary>
        [JsonProperty(PropertyName = "service")]
        public Iok8sapiadmissionregistrationv1beta1ServiceReference Service { get; set; }
        ...
        /// not allowed. Fragments ("#...") and query parameters ("?...") are
        /// not allowed, either.
        /// </summary>
