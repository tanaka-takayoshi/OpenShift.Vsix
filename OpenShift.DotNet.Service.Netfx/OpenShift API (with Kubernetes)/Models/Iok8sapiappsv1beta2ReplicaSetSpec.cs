...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiappsv1beta2ReplicaSetSpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta2ReplicaSetSpec class.
        /// </summary>
        public Iok8sapiappsv1beta2ReplicaSetSpec() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta2ReplicaSetSpec class.
        /// </summary>
        public Iok8sapiappsv1beta2ReplicaSetSpec(Iok8sapimachinerypkgapismetav1LabelSelector selector, int? minReadySeconds = default(int?), int? replicas = default(int?), Iok8sapicorev1PodTemplateSpec template = default(Iok8sapicorev1PodTemplateSpec))
        {
        ...
        /// count. Label keys and values that must match in order to be
        /// controlled by this replica set. It must match the pod template's
        /// labels. More info:
