...
namespace OpenShift.DotNet.Service.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiappsv1beta1StatefulSetSpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta1StatefulSetSpec class.
        /// </summary>
        public Iok8sapiappsv1beta1StatefulSetSpec() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiappsv1beta1StatefulSetSpec class.
        /// </summary>
        public Iok8sapiappsv1beta1StatefulSetSpec(string serviceName, Iok8sapicorev1PodTemplateSpec template, string podManagementPolicy = default(string), int? replicas = default(int?), int? revisionHistoryLimit = default(int?), Iok8sapimachinerypkgapismetav1LabelSelector selector = default(Iok8sapimachinerypkgapismetav1LabelSelector), Iok8sapiappsv1beta1StatefulSetUpdateStrategy updateStrategy = default(Iok8sapiappsv1beta1StatefulSetUpdateStrategy), IList<Iok8sapicorev1PersistentVolumeClaim> volumeClaimTemplates = default(IList<Iok8sapicorev1PersistentVolumeClaim>))
        {
        ...
        /// count. If empty, defaulted to labels on the pod template. More
        /// info:
        ...
        public Iok8sapiappsv1beta1StatefulSetUpdateStrategy UpdateStrategy { get; set; }
