...
namespace OpenShift.DotNet.Service.Models
{
    ...
    public partial class Iok8sapicorev1ConfigMapProjection
    {
        ...
        /// Iok8sapicorev1ConfigMapProjection class.
        /// </summary>
        public Iok8sapicorev1ConfigMapProjection() { }

        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapicorev1ConfigMapProjection class.
        /// </summary>
        public Iok8sapicorev1ConfigMapProjection(IList<Iok8sapicorev1KeyToPath> items = default(IList<Iok8sapicorev1KeyToPath>), string name = default(string), bool? optional = default(bool?))
        {
            Items = items;
            Name = name;
            Optional = optional;
