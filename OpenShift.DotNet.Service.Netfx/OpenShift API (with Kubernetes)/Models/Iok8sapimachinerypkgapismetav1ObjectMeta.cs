...
namespace OpenShift.DotNet.Service.Models
{
    ...
    public partial class Iok8sapimachinerypkgapismetav1ObjectMeta
    {
        ...
        /// Iok8sapimachinerypkgapismetav1ObjectMeta class.
        /// </summary>
        ...
        /// Iok8sapimachinerypkgapismetav1ObjectMeta class.
        /// </summary>
        public Iok8sapimachinerypkgapismetav1ObjectMeta(IDictionary<string, string> annotations = default(IDictionary<string, string>), string clusterName = default(string), DateTime? creationTimestamp = default(DateTime?), long? deletionGracePeriodSeconds = default(long?), DateTime? deletionTimestamp = default(DateTime?), IList<string> finalizers = default(IList<string>), string generateName = default(string), long? generation = default(long?), Iok8sapimachinerypkgapismetav1Initializers initializers = default(Iok8sapimachinerypkgapismetav1Initializers), IDictionary<string, string> labels = default(IDictionary<string, string>), string name = default(string), string namespaceProperty = default(string), IList<Iok8sapimachinerypkgapismetav1OwnerReference> ownerReferences = default(IList<Iok8sapimachinerypkgapismetav1OwnerReference>), string resourceVersion = default(string), string selfLink = default(string), string uid = default(string))
        {
        ...
        /// to distinguish resources with same name and namespace in
        /// different clusters. This field is not set anywhere right now and
        /// apiserver is going to ignore it if set in create or update
        /// request.
        /// </summary>
        ...
        /// visible from resource lists, and not reachable by name) after the
        /// time in this field, once the finalizers list is empty. As long as
        ...
        /// until an administrator or automated process can determine the
        /// resource is fully terminated. If not set, graceful deletion of
        ...
        /// empty, this object has been completely initialized. Otherwise,
        /// the object is considered uninitialized and is hidden (in
        ...
        /// modify this list. Once it is empty, it may not be modified
        /// further by any user.
        /// </summary>
        ...
        /// list have been deleted, this object will be garbage collected. If
        /// this object is managed by a controller, then an entry in this
        /// list will point to this controller, with the controller field set
        /// to true. There cannot be more than one managing controller.
        /// </summary>
        [JsonProperty(PropertyName = "ownerReferences")]
        public IList<Iok8sapimachinerypkgapismetav1OwnerReference> OwnerReferences { get; set; }
        ...
        /// changed. May be used for optimistic concurrency, change
        ...
        public virtual void Validate()
        {
            ...
            {
                this.Initializers.Validate();
            }
            if (this.OwnerReferences != null)
            {
                foreach (var element in this.OwnerReferences)
                {
                    if (element != null)
                    {
                        element.Validate();
