...
namespace OpenShift.DotNet.Service.Models
{
    ...
    public partial class Iok8sapicorev1ReplicationControllerCondition
    {
        ...
        /// Iok8sapicorev1ReplicationControllerCondition class.
        /// </summary>
        public Iok8sapicorev1ReplicationControllerCondition(string status, string type, DateTime? lastTransitionTime = default(DateTime?), string message = default(string), string reason = default(string))
        {
